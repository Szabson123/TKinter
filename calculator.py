...
buttonclear = Button(root, text="C", padx=87, pady=20, command=lambda: count(1))
button0 = Button(root, text="0", padx=40, pady=20, command=lambda: count(0))
buttonadd = Button(root, text="+", padx=40, pady=20, command=lambda: count(1))
buttoneven = Button(root, text="=", padx=87, pady=20, command=lambda: count(1))
