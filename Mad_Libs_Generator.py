...
def story1():
    ...
    def text(name, enter_a_game, eneter_a_city, player, drink, snack):
        #text = f"One fine day, my friend {name} and I planned to engage in a {enter_a_game} match in {eneter_a_city}. However, circumstances didn't allow us to participate. Instead, we ended up attending the game and saw our most admired athlete, {player}, in action. We sipped on {drink} and munched on some {snack}. It was truly an enjoyable experience! We are eagerly anticipating another opportunity to go and relish the moment."
        pass
